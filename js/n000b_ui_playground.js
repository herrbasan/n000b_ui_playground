...
import ani from "../nui/nui_animation.js";
...
import dragSlider from '../nui/nui_drag_slider.js';
...
function go(obj){
	...
	if(obj.page == 'misc' && obj.id == 'animation'){
		init_page_animation();
	}
...
function init_page_animation(){
	if(g.page_animation) { return;}
	g.page_animation = ut.htmlObject(/*html*/`
